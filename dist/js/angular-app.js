...
var prefix = '';
var prefix = 'ansar_operation_web/ansar_operation_web/';
...
//                        var a = response;
    ...
    $routeProvider.when('/withdraw/:id', {
        templateUrl: '/' + prefix + 'operation/kpi-withdraw-action-view',
        controller: 'WithdrawActionController',
        resolve: {
            kpiInfo: function ($http, $route) {
                return $http.get('/' + prefix + 'operation/kpiinfo/' + $route.current.params.id).then(function (response) {
...
GlobalApp.directive('templateList', function () {
    return {
        ...
        templateUrl: function (elem, attrs) {
            ...
            return '/' + prefix + 'operation/template_list/' + attrs.key
        },
...
GlobalApp.factory('httpService', function ($http) {
    ...
    return {
        range: function (id,oz) {
            ...
            return $http({
                method: 'get',
                url: '/' + prefix + 'operation/DivisionName',
                params: {oz: oz}
        ...
        unit: function (id) {
            ...
            if (id == undefined) {
                http = $http({
                    method: 'get',
                    url: '/' + prefix + 'operation/DistrictName'
                })
            }
            else {
                http = $http({
        ...
        thana: function (division, id) {
            ...
            //    http = $http({
            //        method: 'get',
            //        url: '/' + prefix + 'operation/ThanaName'
            //    })
            //}
            //else {
            http = $http({
        ...
        union: function (division, unit, thana) {
            ...
            http = $http({
                method: 'get',
                url: '/' + prefix + 'operation/union/showall',
        ...
        rank: function () {
            return $http({
                url: '/' + prefix + 'opearation/ansar_rank',
                method: 'get'
            }).then(function (response) {
                return response.data;
            }, function (response) {
        ...
        mainTraining: function () {
            return $http({
                url: '/' + prefix + 'operation/main_training/all',
                method: 'get'
            }).then(function (response) {
                return response.data;
            }, function (response) {
        ...
        subTraining: function (id) {
            return $http({
                url: '/' + prefix + 'opearation/sub_training/all/' + id,
                method: 'get'
            }).then(function (response) {
                return response.data;
            }, function (response) {
        ...
        disease: function () {
            return $http.get('/' + prefix + 'operation/getDiseaseName').then(function (response) {
                return response.data;
            })
        },
        skill: function () {
            return $http.get('/' + prefix + 'operation/getallskill')
        },
        education: function () {
            return $http.get('/' + prefix + 'operation/getalleducation').then(function (response) {
                return response.data;
            })
        },
        VdpDesignation: function () {
            return $http.get('/' + prefix + 'operation/getalldesignation').then(function (response) {
                return response.data;
            })
        },
        bloodGroup: function () {
            return $http.get('/' + prefix + 'operation/getBloodName').then(function (response) {
                return response.data;
            })
        },
...
GlobalApp.controller('WithdrawActionController', function ($scope, $http, kpiInfo, $routeParams, $location, notificationService) {
    ...
    $scope.submitForm = function () {
        ...
        $http({
            url: '/' + prefix + 'operation/kpi-withdraw-update/' + $routeParams.id,
            method: 'post',
...
GlobalApp.directive('filterTemplate', function ($timeout, $rootScope) {
    ...
    return {
        ...
        templateUrl: '/' + prefix + 'operation/template_list/range_unit_thana_kpi_rank_gender_template',
        link: function (scope, element, attrs) {
            $rootScope.loadingView = false;
