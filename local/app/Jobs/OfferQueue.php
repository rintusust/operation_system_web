...
class OfferQueue extends Job implements ShouldQueue
{
    ...
    public function __construct($data, $district_id, $user,$userOffer,$offer_type='RE', $memoID='Direct Offer')
    {
        //$this->data = $request;
        $this->data = $data;
        $this->user = $user;
        ...
        for ($i = 0; $i < count($ansar_ids); $i++) {
            ...
            try {
                ...
                if($t){
                    ...
                    //Log::info("Offer Type:".$this->offer_type);
...
//                    'sms_end_datetime' => Carbon::now()->addMinute(),
                ...
                $memorandum_entry->memorandum_id = $memoID;
