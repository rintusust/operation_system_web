...
@section('title','Back To Previous-Batch Upload')
{{-- @section('breadcrumb')
    ...
    <script>
        ...
        GlobalApp.controller('applicantSearch', function ($scope, $http, $q, httpService, $sce, notificationService) {
            ...
            $scope.uploadFileForm = function(){
                ...
                $scope.allLoading = true;
                $http({
                    url:"{{URL::route('HRM.promotion.BackToPreviousBatchUploadByFile')}}",
                    data:fd,
                    method:'post',
                    headers:{
                    ...
                    console.log(response);
                        ...
                        if (response.data.status) {
                            ...
                            notificationService.notify('success', "Ansar/s Successfully Back To Previous...");}
