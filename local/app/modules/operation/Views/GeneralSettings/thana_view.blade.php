...
@section('small_title')
    <a style="background: #3c8dbc; color: #FFFFFF;" class="btn btn-primary btn-sm" href="{{URL::to('operation/thana_form')}}">
    ...
    <script>
        GlobalApp.controller('ThanaViewController', function ($scope, $http, $sce, $compile) {
            ...
            $scope.loadPage = function (page, $event) {
                ...
                $http({
                    url: '{{URL::to('operation/thana_view_details')}}',
                    method: 'get',
                    params: {
                        offset: page.offset,
                        limit: page.limit,
...
//                    $compile($scope.ansars)
            ...
            $http({
                method: 'get',
                url: '{{URL::to('operation/DivisionName')}}'
//                params: {id: d_id}
            }).then(function (response) {
            ...
            $scope.loadDistrict = function (d_id) {
                ...
                $http({
                    method: 'get',
                    url: '{{URL::to('operation/DistrictName')}}',
                    params: {id: d_id}
                }).then(function (response) {
                    ...
                    {{--<ul class="nav nav-tabs">
                        ...
                        <li>
                            <a style="background: #3c8dbc; color: #FFFFFF;" class="btn btn-primary btn-sm"
                               href="{{URL::to('operation/thana_form')}}">
                                <span class="glyphicon glyphicon-plus"></span> Add New Thana
                            </a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr ng-if="thanas.length>0" ng-repeat="a in thanas">
                                        ...
                                        <td>
                                            <div class="col-xs-1">
                                                <a href="{{URL::to('operation/thana_edit/'.'[[a.id]]')}}"
                                                   class="btn btn-primary btn-xs" title="Edit"><span
                                                            class="glyphicon glyphicon-edit"></span></a>
                                            </div>
                                            <div class="col-xs-1">
                                                {{--<a href="{{URL::to('operation/thana_delete/'.'[[a.id]]')}}"
