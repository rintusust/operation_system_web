...
use App\modules\operation\Models\Unions;
...
class UnionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()){
            ...
            return view('operation::unions.data',compact('unions'));
        }
        return view('operation::unions.index');
    }
    ...
    {
        //
        return view('operation::unions.create');
    }
    ...
    public function edit(Request $request,$id)
    {
        ...
        return view('operation::unions.edit',compact('id'));
    }
