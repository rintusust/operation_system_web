...
class UnitController extends Controller
{
    ...
    {
        //
        return View::make('operation::Unit.index');
    }
    ...
    {
        //
        return View::make('operation::Unit.create',['range'=>Division::pluck('division_name_bng','id')]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return Redirect::route('operation.unit.index')->with('success_message','Unit Created Successfully');
    }
    ...
    {
        //
        return View::make('operation::Unit.edit',['unit_info'=>District::find($id),'division'=>Division::pluck('division_name_bng','id')]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        (\Exception $e) {
            DB::rollback();
            return Redirect::route('operation.unit.index')->with('error_message', $e->getMessage());
        }
        return Redirect::route('operation.unit.index')->with('success_message','Unit Updated Successfully');
    }
