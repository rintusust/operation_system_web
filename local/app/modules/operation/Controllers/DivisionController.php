...
class DivisionController extends Controller
{
    ...
    {
        //
        return View::make('operation::Division.index',['data'=>Division::orderBy('sort_by','asc')->get()]);
    }
...
//            return $valid->messages()->toJson();
        ...
        return Redirect::route('operation.range.index')->with('success','Division create complete');
    }
    ...
    {
        //
        return View::make('operation::Division.edit',['data'=>Division::find($id)]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return Redirect::route('operation.range.index')->with('success','Range update complete');
    }
