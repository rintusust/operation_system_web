...
@section('title','Offer Block To Panel')
@section('breadcrumb')
    {!! Breadcrumbs::render('OfferBlockToPanel') !!}
@endsection
@section('content')
    <script>
        GlobalApp.controller("OfferBlockController", function ($scope, $http, $sce, $timeout, notificationService) {
            ...
            $scope.loadData = function (url) {
                if (!url) {
                    url = '{{URL::route('offer_block_to_panel')}}';
                }
			...
			$scope.checkOTP = function(params) {
                ...
                if (angular.isDefined(params.panel_memo_id)){
                    $scope.panel_memo_id = params.panel_memo_id;

                }
                else {
                    //alert('memo not given');
                    $scope.memoError = 'Memo ID is mandatory';
                    return;
                }
                    ...
                    function (response) {
						...
						if(response.data.status == 'success'){
							...
							if($scope_click == 'sendpanel'){
                                ...
                                $scope.param['panel_memo_id'] = $scope.panel_memo_id;
                                  ...
                                  <form ng-submit="checkOTP(params)">
                                   ...
                                   <div class="form-group">
                                      ...
                                      <input type="text" name="mem_id" id="mem_id" class="form-control"
                                             placeholder="memo id" ng-model="params.panel_memo_id">
                                      <p class="text text-danger">[[memoError]]</p>
