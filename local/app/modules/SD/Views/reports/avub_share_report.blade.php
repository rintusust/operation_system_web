...
@section('title','AVUB Share Report')
@section('breadcrumb')
    {!! Breadcrumbs::render('attendance.create') !!}
@endsection
@section('content')
    <script>
        GlobalApp.controller("AVUBShareController", function ($scope, $http, $sce) {
...
`)
            ...
            $scope.loadData = function (url) {
                ...
                $http({
                    method: 'get',
                    url: url||"{{URL::route('SD.reports.avub_share_report')}}",
                    params: $scope.param,
    ...
    <section class="content" ng-controller="AVUBShareController">
