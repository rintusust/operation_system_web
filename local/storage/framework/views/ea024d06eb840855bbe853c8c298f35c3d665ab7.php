<?php $__env->startSection('title','Reduce Ansar In Guard Strength'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('reduce_guard_strength'); ?>
    ...
    <script>
        GlobalApp.controller('AnsarReduceController', function ($scope, $http, notificationService, $filter) {
            ...
            $scope.verifyMemorandumId = function (id) {
                ...
                $http.post('<?php echo e(URL::to('verify_memorandum_id')); ?>', data).then(function (response) {
            ...
            $scope.loadAnsar = function (id) {
                ...
                $http({
                    method: 'get',
                    url: '<?php echo e(URL::route('ansar_list_for_reduce')); ?>',
            ...
            $scope.submitFreezeData = function () {
                ...
                $http({
                    url: '<?php echo e(URL::route('ansar-reduce-update')); ?>',
                    method: 'post',
