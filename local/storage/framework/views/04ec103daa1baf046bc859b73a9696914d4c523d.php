            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                        <form file-upload action="<?php echo e(URL::route('AVURP.info.import_upload')); ?>" method="post"
                ...
                <div style="padding: 20px;display: flex;justify-content: center;" ng-if="errorLink">
                    <a href="<?php echo e(URL::route("AVURP.info.import.download",['file_name'=>''])); ?>/[[errorLink]]" class="btn btn-primary">
