    ...
    <script>
        GlobalApp.controller("RecruitmentSummary", function ($http, $scope) {
            $scope.loadSummary = function () {
                $http({
                    url: "<?php echo e(URL::to('recruitment/getRecruitmentSummary')); ?>",
                    method: "get"
                    ...
                    if (response.data && Array.isArray(response.data)) {
                        jQuery.each(response.data, function (key, category) {
                            ...
                            var data = '<div class="col-sm-12 col-md-6"><div class="box box-solid"><div class="box-body">' +
                                ...
                                '<a href="<?php echo e(URL::to("recruitment/applicant?category=")); ?>' + category.id + '">' + category.category_name_bng + '</a>' +
                                '</h4>' +
                                '<div class="media"><div class="media-body"><div class="clearfix">' +
                                dataHTML +
                                '</div></div></div>' +
                                '<a href="<?php echo e(URL::to("recruitment/applicant?category=")); ?>' + category.id + '" class="small-box-footer bg-aqua">More info <i class="fa fa-arrow-circle-right"></i></a>';
