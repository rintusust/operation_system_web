...
<?php $__env->startSection('small_title'); ?>
    <a style="background: #3c8dbc; color: #FFFFFF;" class="btn btn-primary btn-sm" href="<?php echo e(URL::to('HRM/thana_form')); ?>">
    ...
    <script>
        GlobalApp.controller('ThanaViewController', function ($scope, $http, $sce, $compile) {
            ...
            $scope.loadPage = function (page, $event) {
                ...
                $http({
                    url: '<?php echo e(URL::to('HRM/thana_view_details')); ?>',
                    method: 'get',
                    params: {
                        offset: page.offset,
                        limit: page.limit,
                    ...
                    <?php /*<ul class="nav nav-tabs">
                        ...
                        <li>
                            <a style="background: #3c8dbc; color: #FFFFFF;" class="btn btn-primary btn-sm"
                               href="<?php echo e(URL::to('HRM/thana_form')); ?>">
                                <span class="glyphicon glyphicon-plus"></span> Add New Thana
                            </a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr ng-if="thanas.length>0" ng-repeat="a in thanas">
                                        ...
                                        <td>
                                            <div class="col-xs-1">
                                                <a href="<?php echo e(URL::to('HRM/thana_edit/'.'[[a.id]]')); ?>"
                                                   class="btn btn-primary btn-xs" title="Edit"><span
                                                            class="glyphicon glyphicon-edit"></span></a>
                                            </div>
                                            <div class="col-xs-1">
                                                <?php /*<a href="<?php echo e(URL::to('HRM/thana_delete/'.'[[a.id]]')); ?>"
