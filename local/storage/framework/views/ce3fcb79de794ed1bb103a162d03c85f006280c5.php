...
<div class="login-box" style="margin: 1% auto !important;"  ng-controller="loginController">
    <div class="login-logo">
        <a href="<?php echo e(URL::to('/')); ?>" style="color: #003a37;"><b>Ansar & VDP</b>ERP</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body" style="background: rgba(255, 255, 255, 0.32);">
        ...
        <a href="<?php echo e(URL::route('forget_password_request')); ?>" style="color: #003a37;text-transform: uppercase" >I forgot my password</a><br>
