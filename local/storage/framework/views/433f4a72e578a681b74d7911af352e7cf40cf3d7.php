...
<?php $__env->startSection('title','Edit Union Information'); ?>
...
<?php $__env->startSection('content'); ?>
    <script>
        GlobalApp.controller('UnionEditController', function ($scope,$http,httpService,notificationService) {
            ...
            $http({
                method:'get',
                url:'<?php echo e(URL::route('HRM.union.edit',compact('id'))); ?>'
            ...
            $scope.updateData = function () {
                ...
                $http({
                    method:'post',
                    url:'<?php echo e(URL::route('HRM.union.update',compact('id'))); ?>',
                    data:angular.toJson($scope.data)
                }).then(function (response) {
                    $scope.updating = false
                    window.location.href = '<?php echo e(URL::route('HRM.union.index')); ?>'
                },function (response) {
                    $scope.updating = false
