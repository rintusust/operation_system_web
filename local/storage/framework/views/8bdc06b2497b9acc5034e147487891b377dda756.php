<?php $__env->startSection('title','KPI List'); ?>
        ...
        GlobalApp.controller('KPIController',function ($scope, $http, $sce) {
            ...
            $scope.KpiList = $sce.trustAsHtml(`<div class="table-responsive">
                        <table class="table table-bordered table-condensed">
                            <caption style="font-size: 20px;color:#111111">Total KPI(0) <a href="<?php echo e(URL::route('AVURP.kpi.create')); ?>" class="btn btn-primary btn-xs pull-right">
            ...
            $scope.loadPage = function (url) {
                ...
                $http({
                    url:url||'<?php echo e(URL::route('AVURP.kpi.index')); ?>',
                    method:'get',
                    params:$scope.param
