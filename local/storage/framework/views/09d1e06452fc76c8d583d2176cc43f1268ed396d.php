...
<script>
    ...
    GlobalApp.controller('InfoController', function ($scope, $http, httpService, $q, notificationService,$rootScope) {
        ...
        $q.all([
            ...
            <?php if(isset($id)): ?>
            , $http.get("<?php echo e(URL::route('operation.info.edit',['id'=>$id])); ?>")
            <?php endif; ?>
...
//                if($rootScope.ws) $rootScope.ws.send(JSON.stringify({type:'notification',data:{to:[1],message:response.data.message}}))
                window.location.href = '<?php echo e(URL::route('operation.info.index')); ?>'
            }, function (response) {
                $scope.allLoading = false
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <?php /*<input type="text" class="form-control" placeholder="বর্তমান পদবী" ng-model="info.form.designation"
                           id="rank">*/ ?>
