<?php $__env->startSection('title','Verify Entry (Bulk)'); ?>
    ...
    <script>
        GlobalApp.controller('ChunkVerificationController', function ($scope, $http, $interval) {
            ...
            $scope.loadAnsar = function () {
                ...
                $http({
                    method: 'get',
                    url: '<?php echo e(URL::to('operation/getnotverifiedansar')); ?>',
                    params: {
                        chunk: 'chunk',
                        ...
                        <form id="not-verified-form" method="post" action="<?php echo e(URL::to('HRM/entryChunkVerify')); ?>">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr ng-repeat="a in ansars|filter:q as results"
                                    ...
                                    <td>[[$index+1]]</td>
                                    <td><a href="<?php echo e(URL::to('operation/entryreport')); ?>/[[a.id]]">[[a.id]]</a></td>
                                    <td>[[a.geo_id]]</td>
                                    <td>[[a.name]]</td>
