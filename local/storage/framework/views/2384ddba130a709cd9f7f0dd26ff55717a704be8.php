...
<?php $__env->startSection('title','List Of Ansar Before Guard Reduce'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('ansar_before_reduce_list'); ?>
    ...
    <script>
        GlobalApp.controller('GuardBeforeWithdrawController', function ($scope, $http, $sce) {
            ...
            $scope.loadAnsar = function () {
                ...
                $http({
                    method: 'get',
                    url: '<?php echo e(URL::route('load_ansar_before_reduce')); ?>',
                    params: {
