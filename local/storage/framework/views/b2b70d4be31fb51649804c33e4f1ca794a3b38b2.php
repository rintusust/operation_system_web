<?php $__env->startSection('title','Print ID Card'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('print_card_id_view'); ?>
...
//                var ed = new Date($scope.ed);
                ...
                $http({
                    url: '<?php echo e(URL::to('operation/id_card_history')); ?>',
                    method: 'get',
                    params: {
                        geo_id: $scope.geoId
                    }
    ...
    <div ng-controller="printIdController">
        ...
        <?php /*<?php echo Breadcrumbs::render('print_card_id_view'); ?>*/ ?>
        <?php /*</div>*/ ?>
        <section class="content">
            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    <form action="<?php echo e(URL::route('operation.print_card_id')); ?>" method="post" target="_blank">
                        <?php echo csrf_field(); ?>

                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label">Enter GEO ID</label>
                                <input type="text" class="form-control" name="geo_id" ng-model="geoId"
                                       placeholder="GEO ID">

                                <p class="text text-danger" ng-if="errors.geo_id!=undefined">[[errors.geo_id[0]
                                    ]]</p>
                            </div>
                            <div class="form-group">
