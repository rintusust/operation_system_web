...
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('dashboard_menu', $pageTitle, $type); ?>
    ...
    <script>
        GlobalApp.controller('AnsarListController', function ($scope, $http, $sce, $parse) {
            ...
            $scope.loadPage = function (page, $event) {
                ...
                $scope.allLoading = true;
                $http({
                    url: '<?php echo e(URL::to('HRM/get_ansar_list')); ?>',
                    method: 'get',
                    params: {
                    ...
                    <div id="print_table">
                        <div class="table-responsive">
                            <div>
                                ...
                                <template-list data="ansars" key="<?php echo e($type); ?>" call-back="loadPage()"></template-list>
                            </div>
                        </div>
                    </div>
                    <div class="row">
