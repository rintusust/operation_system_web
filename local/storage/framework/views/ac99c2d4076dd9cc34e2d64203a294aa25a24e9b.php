            ...
            <div class="col-lg-6 col-centered">
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <?php echo Form::model($thana_info,array('route' => 'thana_update', 'class' => 'form-horizontal', 'name' => 'thanaForm', 'ng-controller' => 'ThanaController', 'novalidate')); ?>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group required">
                                <?php echo Form::label('thana_name_bng', 'থানার নাম:', $attributes = array('class' => 'col-sm-4 control-label')); ?>

                                <div class="col-sm-8 <?php if($errors->has('thana_name_bng')): ?> has-error <?php endif; ?>">
                                    <?php echo Form::text('thana_name_bng',null, $attributes = array('class' => 'form-control', 'id' => 'thana_name_bng', 'placeholder' => 'থানার নাম লিখুন বাংলায়')); ?>
