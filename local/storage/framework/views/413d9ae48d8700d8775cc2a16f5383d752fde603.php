        ...
        <ul class="sidebar-menu">
            ...
            <li>
                ...
                <ul class="treeview-menu">
                    <li class="">
                        <a href="<?php echo e(URL::to('SD/demandconstant')); ?>">
                            <i class="fa fa-cog"></i>Demand Constant
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(URL::to('SD/demandsheet')); ?>"><i class="fa fa-file-pdf-o"></i>Generate Demand Sheet</a>
                    </li>
                    <li>
                        <a href="<?php echo e(URL::to('SD/demandhistory')); ?>"><i class="fa fa-history"></i>Demand History</a>
                    </li>
                </ul>
            </li>
            <li>
...
<aside class="main-sidebar" ng-controller="MenuController">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <?php echo $__env->make('HRM::Partial_view.partial_menu',['menus'=>config('menu.sd')], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </ul>
    </section>
    <!-- /.sidebar -->
    <script>
