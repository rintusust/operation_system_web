<?php $__env->startSection('title','Import Image Data'); ?>
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                        <form file-upload action="<?php echo e(URL::route('operation.image_import_upload')); ?>" method="post"
...
<?php /*                                <input type="file" name="import_file" class="file" data-show-preview="false">*/ ?>
