<?php $__env->startSection('title','Printed ID Card List'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('id_card'); ?>
    ...
    <script>
        ...
        GlobalApp.controller('AnsarIdCard', function ($scope,$http) {
            ...
            $scope.loadAnsar = function () {
                ...
                $http({
                    url:'<?php echo e(URL::to('operation/get_print_id_list')); ?>',
                    method:'get',
            ...
            $scope.blockAnsarCard = function (a) {
                ...
                $http({
                    url:'<?php echo e(URL::to('operation/change_ansar_card_status')); ?>',
                    method:'post',
                    data:{action:'block',geo_id: $scope.ansars[a].geo_id}
                }).then(function (response) {
            ...
            $scope.activeAnsarCard = function (a) {
                ...
                $http({
                    url:'<?php echo e(URL::to('operation/change_ansar_card_status')); ?>',
                    method:'post',
                    data:{action:'active',geo_id: $scope.ansars[a].geo_id}
                }).then(function (response) {
