<?php $__env->startSection('title','Global Parameter'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('global_parameter'); ?>
        ...
        GlobalApp.controller('GlobalParameterController', function ($scope, $http) {
            ...
            <?php for($i=0;$i<count($gp);$i++): ?>
                $scope.globalParam.push({
                        id:'<?php echo e($gp[$i]->id); ?>',
                        param_name:'<?php echo e($gp[$i]->param_name); ?>',
                        param_value:'<?php echo e($gp[$i]->param_value); ?>',
                        param_unit:'<?php echo e($gp[$i]->param_unit); ?>',
                        param_description:'<?php echo e($gp[$i]->param_description); ?>',
                        param_piority:'<?php echo e($gp[$i]->param_piority); ?>'
                    })
            <?php endfor; ?>
            $scope.updateGlobalParameter = function (id,i) {
                ...
                $scope.error[i] = ""
                $http({
                    url:'<?php echo e(URL::to('HRM/global_parameter_update')); ?>',
                    method:'post',
                    data:{
                        id:parseInt(id),
                        pv:$scope.value[i],
