<?php $__env->startSection('title','Entry Information'); ?>
<?php $__env->startSection('small_title'); ?>
    <a href="<?php echo e(URL::to('HRM/entryform')); ?>" class="btn btn-info btn-sm"><span
                class="glyphicon glyphicon-user"></span> Add New</a>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('entry_list'); ?>
...
<?php $__env->startSection('content'); ?>
    <script>
        GlobalApp.controller('AnsarController', function ($scope, $http, notificationService) {
            ...
            $scope.sort = 'desc'
            $scope.userType = parseInt('<?php echo e(Auth::user()->type); ?>');
            $scope.notVerified = parseInt("<?php echo e($notVerified); ?>");
            $scope.Verified = parseInt("<?php echo e($Verified); ?>");
            $scope.numOfPage = 0
            ...
            $scope.loadAnsar = function (page, $event) {
                ...
                $scope.AllAnsar = [];
                $http({
                    url: $scope.loadType == 0 ? "<?php echo e(URL::to('HRM/getnotverifiedansar')); ?>" : "<?php echo e(URL::to('HRM/getverifiedansar')); ?>",
                    method: 'get',
                    params: {
                        limit: page.limit,
                        offset: page.offset,
...
//                alert(id+"  "+i);return;
                ...
                $http({
                    url: "<?php echo e(URL::to('HRM/entryVerify/')); ?>",
                    data: {verified_id: id},
                    method: 'post'
                }).then(function (response) {
...
//                return;
                $http({
                    url: "<?php echo e(URL::to('HRM/reject')); ?>",
                    data: {reject_id: id},
                    method: 'post'
                }).then(function (response) {
                    //alert(JSON.stringify(response.data));
...
//                    alert($scope.verified[i]);
            ...
            $scope.searchId = function () {
                ...
                $http({
                    url: "<?php echo e(URL::to('HRM/entrysearch')); ?>",
                    method: 'post',
    ...
    <div ng-controller="AnsarController">
        ...
        <?php /*<?php echo Breadcrumbs::render('entry_list'); ?>*/ ?>
        <?php /*</div>*/ ?>
        ...
        <?php if(Session::has('edit_success')): ?>
            <div style="padding: 20px 10px">
                <div class="alert alert-success">
                    ...
                    <span class="glyphicon glyphicon-ok"></span>Ansar with ID: <?php echo e(Session::get('edit_success')); ?> Edited
                    successfully
                </div>
            </div>
        <?php endif; ?>
        <?php if(Session::has('add_success')): ?>
            <div style="padding: 20px 10px">
                <div class="alert alert-success">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <span class="glyphicon glyphicon-ok"></span> Ansar with ID: <?php echo e(Session::get('add_success')); ?> Added
                    Successfully
                </div>
            </div>
        <?php endif; ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="ansar-table">
                            ...
                            <tr ng-repeat="ansar in AllAnsar" ng-if="AllAnsar.length>0">
                                ...
                                <td>
                                    <a href="<?php echo e(URL::to('HRM/entryreport/')); ?>/[[ansar.ansar_id]]">[[ansar.ansar_id]]</a>
                                </td>
                                ...
                                <td style="padding-right: 1px;padding-left: 1px">
                                    <div style="position:relative;margin: 0 auto;display: table">
                                        ...
                                        <a ng-if="userType == 55 && ansar.verified == 0" class="btn btn-primary btn-xs"
                                           title="edit" href="<?php echo e(url('HRM/editEntry/')); ?>/[[ansar.ansar_id]]"><span
                                                    class="glyphicon glyphicon-edit"></span></a>
                                        <a ng-if="userType == 55 && ansar.verified == 1"
                                           class="btn btn-primary btn-xs disabled" title="Edit"><span
                                                    class="glyphicon glyphicon-edit"></span></a>
                                        <?php /*data entry edit end*/ ?>
                                        <?php /*data entry verify*/ ?>
                                        ...
                                        <a ng-if="userType == 44 && ansar.verified == 1" class="btn btn-primary btn-xs"
                                           title="Edit"
                                           href="<?php echo e(URL::to('HRM/editEntry/')); ?>/[[ansar.ansar_id]]"><span
                                                    class="glyphicon glyphicon-edit"></span></a>
                                        <a ng-if="userType == 44 && ansar.verified == 2" href="<?php echo e(URL::to('HRM/editVerifiedEntry/')); ?>/[[ansar.ansar_id]]" class="btn btn-primary btn-xs" title="edit">
                                            <span class="glyphicon glyphicon-edit"></span>
                                        </a>
                                        <?php /*checker edit end*/ ?>
                                        <?php /*checker verify*/ ?>
                                        ...
                                        <?php /*checker reject end*/ ?>

                                        <?php /*admin,dc,rc,dg edit*/ ?>
                                        ...
                                        <a ng-if="(userType == 11||userType == 77 || userType == 22 || userType == 33 || userType == 66) && (ansar.verified == 2)" class="btn btn-primary btn-xs"
                                           href="<?php echo e(URL::to('HRM/editVerifiedEntry/')); ?>/[[ansar.ansar_id]]" title="Edit">
                                            <span class="glyphicon glyphicon-edit"></span>
                                        </a>

                                        <?php /*admin,dc,rc,dg edit end*/ ?>
                                        <?php /*admin,dc,rc,dg verify*/ ?>
                                        ...
                                        <?php /*admin,dc,rc,dg verify end*/ ?>
                                        <?php /*<div class="col-xs-1">*/ ?>
                                        <?php /*<a class="btn btn-danger btn-xs" title="block"><span*/ ?>
                                        <?php /*class="glyphicon glyphicon-remove-circle"></span></a>*/ ?>
                                        <?php /*</div>*/ ?>
                                    </div>
                                </td>
                            </tr>
